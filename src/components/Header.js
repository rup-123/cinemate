...
export const Header = ({ onMediaTypeChange }) => {
  ...
  const handleClick = (event, mediaType) => {
          ...
          <div className="flex md:order-2">
            ...
            <div className={`${hidden? "hidden " : " "}items-center justify-between w-full md:flex md:w-auto md:order-1`} id="navbar-search">
              ...
              <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li onClick={(e)=>handleClick(e,"movies")}>
                  <NavLink to="/"  className={({isActive})=>isActive? activeClass: inactiveClass} end>Movies</NavLink>
                </li>
                <li onClick={(e)=>handleClick(e,"tv")}>
                  <NavLink to="tv"  className={({isActive})=>isActive? activeClass: inactiveClass} >TV Shows</NavLink>
                </li>
                <li>
                  <NavLink to="fav" className={({isActive})=>isActive? activeClass: inactiveClass}>Your Favourites</NavLink>
                </li>
              </ul>
            </div>
          </div>
